    ...
    for (let index = 0; index < count; index++) {
        ...
        if(argent.status != 'deleted'){
            ...
            if(argent.type == "depense"){
                ...
                <svg class="size-5 text-[#f29a00]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M6 12L18 12" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg><data>
                <path d="M6 12H18M12 6V18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> 
                </g></svg>
                <data>${argent.montant}</data>dh
                </div>
                <div class="flex gap-2">
                    <button class="size-10" onclick="remplirForm(${index})">
                    ...
                    <button class="size-10" onclick="deleteTR(${index})">
            ...
            argent.type == "depense" ? element.classList.add("bg-red-400"):element.classList.add("bg-[#34D171]");
